        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h2 className="text-xl font-semibold text-blue-900 dark:text-blue-100 mb-2">
              Gestione Pazienti & Esercizi
            </h2>
            <p className="text-blue-700 dark:text-blue-300 text-sm leading-relaxed">
              In questa sezione puoi <strong>creare nuovi pazienti</strong>, <strong>assegnare esercizi</strong> per ogni giorno della settimana, 
              e <strong>monitorare i progressi</strong>. Seleziona un paziente dalla lista per gestire i suoi esercizi settimanali.
            </p>
          </div>
        </div>
      </div>
