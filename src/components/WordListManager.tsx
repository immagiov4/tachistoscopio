...
export const WordListManager: React.FC<WordListManagerProps> = ({
  ...
  return <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <Card className="lg:col-span-1 flex flex-col h-fit">
          <CardHeader>
          ...
          <CardContent className="space-y-4 flex-1 flex flex-col min-h-0 overflow-y-auto">
            {savedWordLists.length === 0 ? <div className="text-center py-6 text-gray-500">
                ...
                <p className="text-xs">Crea il tuo primo esercizio</p>
                 ...
                 {savedWordLists.slice(0, 4).map(list => <div key={list.id} className={`p-3 border rounded-lg cursor-pointer transition-all hover:shadow-sm ${editingList === list.id ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300'}`} onClick={() => handleEditWordList(list)}>
